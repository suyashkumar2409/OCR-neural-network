...
class Network(object):
	...
	def graddesc(self,trainingdata,epochs,minibatchsize,eta,testdata = None,lamda=0.0):
	...
	def relax(self,mini,eta,lamda):	
		...
		self.biases = [(1-eta*(lamda/n))*b - (eta/len(mini))*db for b,db in zip(self.biases,biastemp)]
		self.weights = [(1-eta*(lamda/n))*w - (eta/len(mini))*dw for w,dw in zip(self.weights,weighttemp)]
